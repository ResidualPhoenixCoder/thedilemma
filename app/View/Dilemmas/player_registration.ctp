...
function validate(dataObj) {
    ...
    if(dataObj.clantag === "") {
        $("#txf_clantag").addClass('border_error');
        result = false;
    } else {
        $("txf_user").removeClass('border_error');
    }
...
$(function() {
    ...
    $('#form_registration')
            .submit(function(event) {
                ...
                formDataObj.clantag = $("#txf_clantag").val();
                ...
                if(validate(formDataObj)) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo Router::url(array('controller' => 'registrations', 'action' => 'register')); ?>",
                        data: formData,
...
<div>
        <?php echo $this->Form->create('registration', array('id' => 'form_registration')); ?>
	<table id="treg">
		...
		<tr><td>Username:</td><td><?php echo $this->Form->input('Username', array('id' => 'txf_user', 'class' => 'registration_fields', 'label' => false)); ?></td></tr>
                <tr><td>Clan Tag:</td><td><?php echo $this->Form->input('Clan_Tag', array('id' => 'txf_clantag','class' => 'registration_fields', 'label' => false)); ?></td></tr>
